 ...
 */
// TODO do we really need all this report content?
@ReportsCrashes(formKey = "", formUri = "http://zephyrsoft.net/crashreport.jsp",
	mode = ReportingInteractionMode.SILENT, customReportContent = {REPORT_ID, APP_VERSION_CODE, APP_VERSION_NAME,
		...
		AVAILABLE_MEM_SIZE, CUSTOM_DATA, STACK_TRACE, INITIAL_CONFIGURATION, CRASH_CONFIGURATION, DISPLAY,
		USER_APP_START_DATE, USER_CRASH_DATE, DUMPSYS_MEMINFO, LOGCAT, INSTALLATION_ID, DEVICE_FEATURES, ENVIRONMENT,
